<?php 
  ...
  if($is_published) :
?>
<section class="uni_section uni_section__posts <?php echo $section_has_title; echo $section_type; ?> grid-with-margin" data-post-type="post" data-section_order="<?php echo $i ?>" data-per_page="<?php echo $per_page ?>" data-post_type="<?php echo $uni_post_type; ?>">
