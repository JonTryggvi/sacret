<form class="mailchimp--form grid-span--<?php echo $columns; ?>">
  ...
  <input id="mailchimp_fname_<?php echo $id_index; ?>" type="text" name="fname" class="txtInp txtInp--w75 mc-name hide"autocomplete="autocomplete_off_hack_xfr4!t" >
  ...
  <input id="mailchimp-lname_<?php echo $id_index; ?>" type="text" name="lname" class="txtInp txtInp--w75 mc-name hide" autocomplete="autocomplete_off_hack_xfr4!m">
